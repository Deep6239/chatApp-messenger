    ...
    {friendRequests.length === 0 ? (
      ...
      friendRequests.map((request) => (
        <div key={request.senderId} className='flex gap-4 items-center'>
          ...
          <button onClick={()=> denyFriend(request.senderId)} aria-label='deny friend' className='w-8 h-8 bg-red-600 hover:bg-indigo-700 grid place-items-center rounded-full transition hover:shadow-md'>
